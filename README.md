...
- **Clang Polly** — [Peter Jung e Username404-59 / CachyOS](https://github.com/CachyOS/kernel-patches): ativa o otimizador poliédrico de loops. O build prefere a implementação Polly já integrada ao Clang e remove `-fplugin=LLVMPolly.so` quando o carregamento duplicaria as opções; o plugin externo permanece como fallback para toolchains sem Polly embutido.
